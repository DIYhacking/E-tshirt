...
#define GPIOA_PULSE		    1 //heart rate sensor
#define GPIOA_VPOS_CTRL		2
#define GPIOA_VNEG_CTRL		3
#define GPIOA_NOTHING	    4
#define GPIOA_LM35   	    5 //temperature sensor
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_BUTTONS) |       \
                                     PIN_MODE_INPUT(GPIOA_PULSE) |           \
                                     PIN_MODE_OUTPUT(GPIOA_VPOS_CTRL) |     \
                                     PIN_MODE_OUTPUT(GPIOA_VNEG_CTRL) |     \
                                     PIN_MODE_INPUT(GPIOA_NOTHING) |  \
                                     PIN_MODE_INPUT(GPIOA_LM35) |   \
...
#define VAL_GPIOA_PUPDR             (PIN_PUDR_PULLDOWN(GPIOA_PULSE) |        \
                                     PIN_PUDR_FLOATING(GPIOA_NTC_IN) |      \
                                     PIN_PUDR_PULLUP(8) |                   \
									 PIN_PUDR_PULLDOWN(GPIOA_LM35) |   \
                                     PIN_PUDR_PULLDOWN(GPIOA_NOTHING) | \
...
#define VAL_GPIOC_MODER             (PIN_MODE_OUTPUT(GPIOC_EINK_GMODE) |    \
									 PIN_MODE_INPUT(GPIOC_GSR) |            \
                                     PIN_MODE_ANALOG(GPIOC_OSC32_IN) |       \
                                     PIN_MODE_ANALOG(GPIOC_OSC32_OUT))
#define VAL_GPIOC_OTYPER            0x00000000
#define VAL_GPIOC_PUPDR				(PIN_PUDR_PULLDOWN(GPIOC_GSR))
